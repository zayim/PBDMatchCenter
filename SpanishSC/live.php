...
<tr><td>&nbsp;</td></tr>
<tr>
<td width="180px"><table>

<?php
for ($i=0; $i<11; $i++)
{
	echo "<tr>";
	echo "<td class='sastav_td_broj'>".$brojevi[$i]."</td><td class='sastav_td_ime' style='background:none'>".$imena[$i];
	if (isset($statusi[$i]) && $statusi[$i]==2) echo " (Ušao)";
	echo "</td>";
	echo "</tr>";
}
?>
...
<td width="50%">
<span class="sastav_td_broj" style="background:none; color:#FFF">
KLUPA
</span>
<table>
...
{
	echo "<tr>";
	echo "<td class='sastav_td_broj'>".$klupa_brojevi[$i]."</td><td class='sastav_td_ime' style='color:#CCC; background:none'>".$klupa_imena[$i];
	if (isset($klupa_statusi[$i]) && $klupa_statusi[$i]==3) echo " (Izašao)";
	echo "</td>";
	echo "</tr>";
}
?>
