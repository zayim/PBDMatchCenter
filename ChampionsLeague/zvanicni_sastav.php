...
<table>
	<tr>
		<td class="igrac_klupa">
    		<span style="color:#0CF"> <?php echo $klupa1_broj ?> </span>
         	<?php echo $klupa1_ime ?>
    	</td>
    
   		<td class="igrac_klupa">
    		<span style="color:#0CF"> <?php echo $klupa2_broj ?> </span>
         	<?php echo $klupa2_ime ?>
    	</td>
        
        <td class="igrac_klupa">
    		<span style="color:#0CF"> <?php echo $klupa3_broj ?> </span>
         	<?php echo $klupa3_ime ?>
    	</td>
    
   		<td class="igrac_klupa">
    		<span style="color:#0CF"> <?php echo $klupa4_broj ?> </span>
         	<?php echo $klupa4_ime ?>
    	</td>
    </tr>
</table>
...
<table>
	<tr>
		<td class="igrac_klupa">
    		<span style="color:#0CF"> <?php echo $klupa5_broj ?> </span>
         	<?php echo $klupa5_ime ?>
    	</td>
    
   		<td class="igrac_klupa">
    		<span style="color:#0CF"> <?php echo $klupa6_broj ?> </span>
         	<?php echo $klupa6_ime ?>
    	</td>
        
        <td class="igrac_klupa">
    		<span style="color:#0CF"> <?php echo $klupa7_broj ?> </span>
         	<?php echo $klupa7_ime ?>
    	</td>
    
   		<td class="igrac_klupa">
    		<span style="color:#0CF"> TR </span>
         	Tito Vilanova
    	</td>
    </tr>
</table>
