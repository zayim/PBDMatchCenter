...
<?php
	...
	echo "<tr><td class='broj' style='color:#CCC'>Dres</td>";
	echo "<td class='broj' style='color:#CCC'>Igrač</td>";
	echo "<td class='broj' style='color:#CCC'>Ocjena (broj glasova)</td>";
	echo "<td class='broj' style='color:#CCC'>Glasovi (igrač utakmice)</td></tr>";
	...
	<center>
	<label class="broj"style="font-size:28px"> Igrač utakmice: </label>
	<label class="ime" style="padding-left:5px; font-size:28px">
_END;
