...
Powered by: <a href="http://www.barcabih.com" style="cursor:url(../slike/cursor.png), pointer;"> Bar&#231;a BiH</a> | Igrac utakmice i ocjene
</span>
</center>
...
<?php
	...
	echo "<tr><td> <div style='height:65px'></div></td></tr>";
	echo "<tr style='width:100%'><td class='broj' style='color:#FFF; background:none; width:50px; font-family:Din'>Dres</td>";
	echo "<td class='broj' style='color:#FFF; background:none; font-family:Din'>Igrac</td>";
	echo "<td class='broj' style='color:#FFF; background:none; width:150px; font-family:Din'>Ocjena</td>";
	echo "<td class='broj' style='color:#FFF; background:none;  width:150px; font-family:Din'>Igrac utakmice</td></tr>";
	...
	<center>
	<label class="broj" style="font-size:24px; font-family:Din; color:#FFF; background:none"> Igrac utakmice: </label>
...
_END;
	...
	<center>
	 <input type="button" value="Pocetna" class="dugme" onclick="window.location.href='index.php'"/>
	 </center>
_END;
