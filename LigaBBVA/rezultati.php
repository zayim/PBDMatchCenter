...
<center><span style="padding:5px; background:#051A30; opacity:0.8; text-align:center"> TOP 10 </span></center>
<br />
<table width="100%">
<tr>
</tr>
<?php
	...
	for ($i=0; $i<$broj_igraca; $i++)
	{
		...
		echo "<td style='padding:5px; text-align:left; background:#051A30; opacity:0.8; width:10%'> ".($i+1).". </td>";
		echo "<td style='padding:5px; text-align:left; background:#051A30; opacity:0.8; width:40%'> ".$red['ime']." </td>";
		echo "<td style='padding:5px; text-align:left; background:#051A30; opacity:0.8; width:50%'> ".$red['broj_glasova']." ($postotak%)</td>";
		echo "</tr>";
	}
?></table>
</div></td>
...
<td> <div id="stats_desno" style="padding:5px; background:#051A30; opacity:0.8;"> Broj glasova: <?php echo round($broj_glasova); ?> </div></td>

</tr></table></center>
<center>
<input type="button" class="dugme" value="Pocetna" onclick="window.location.href='index.php'" />
</center>
